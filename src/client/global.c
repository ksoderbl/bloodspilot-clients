...
/* $Id: global.c,v 1.36 2007/12/11 21:44:56 kps Exp $ */
...
unsigned char *map_edge_descriptor_array;
...
selection_t selection;		/* selections in draw and talk window */
...
bool dirPrediction;		/* predict ship direction on server? */
...
int motd_viewer;		/* so Windows can clean him up */
int keys_viewer;
...
display_t server_display;	/* the servers idea about our display */
